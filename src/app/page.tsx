  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-3 gap-2">
        <div className="border rounded-lg p-5 flex flex-col gap-4 lg:row-span-2 col-span-3 bg-accent/20">
        ...
        <div className="flex flex-col gap-5 border col-span-3 lg:col-span-2 rows-span-1 h-fit rounded-lg p-5 bg-accent/20">
              ...
              <div key={index} className="flex gap-5">
                ...
                <div className="w-full">
                  <div className="flex flex-col gap-1.5">
                    <h1 className="text-[0.7rem] lg:text-sm font-semibold text-primary">
                      {title}
                    </h1>
                  </div>
                  <div className="flex items-center w-full justify-between">
                    <p className="text-[0.6rem] lg:text-xs text-primary">
                      {description}
                    </p>
        ...
        <div className="flex flex-col gap-4 col-span-3 lg:col-span-1 row-span-3 border rounded-lg p-5 bg-accent/20">
        ...
        <div className="flex flex-col gap-4 border rounded-lg bg-accent/20 row-span-3 col-span-3 h-fit lg:col-span-2 p-5 text-sm font-semibold">
        ...
        <div className="flex flex-col rounded-lg border p-5 col-span-3 lg:col-span-1 bg-accent/20 hover:transform hover:-translate-y-0.5 duration-200 ease-in-out">
